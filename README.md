...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x9p7ghy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x9p7ghy.containers.anotherwebservice.com/
...
```
git clone git@github.com:2000turnips/container-x9p7ghy.git
cd container-x9p7ghy
```
...
```
docker attach container-x9p7ghy
```
